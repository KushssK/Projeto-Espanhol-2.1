...
export type GetAppSettingsAggregateType<T extends AppSettingsAggregateArgs> = {
    [P in keyof T & keyof AggregateAppSettings]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateAppSettings[P]> : Prisma.GetScalarType<T[P], AggregateAppSettings[P]>;
};
...
export type GetAppSettingsGroupByPayload<T extends AppSettingsGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<AppSettingsGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof AppSettingsGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], AppSettingsGroupByOutputType[P]> : Prisma.GetScalarType<T[P], AppSettingsGroupByOutputType[P]>;
}>>;
export type AppSettingsWhereInput = {
    ...
    themeColor?: Prisma.StringFilter<"AppSettings"> | string;
...
export type AppSettingsScalarWhereWithAggregatesInput = {
    ...
    themeColor?: Prisma.StringWithAggregatesFilter<"AppSettings"> | string;
...
export type AppSettingsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "themeColor" | "logoUrl" | "updatedAt", ExtArgs["result"]["appSettings"]>;
...
export type AppSettingsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<AppSettingsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AppSettingsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends AppSettingsCountArgs>(args?: Prisma.Subset<T, AppSettingsCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], AppSettingsCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends AppSettingsGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, AppSettingsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAppSettingsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface AppSettingsFieldRefs {
    ...
    readonly themeColor: Prisma.FieldRef<"AppSettings", 'String'>;
