...
export type UserOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "email" | "username" | "passwordHash" | "dob" | "role" | "cpfHash" | "avatarUrl" | "isBanned" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>;
