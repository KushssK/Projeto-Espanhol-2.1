 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.whitelist_CPF`: Exposes CRUD operations for the **Whitelist_CPF** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more Whitelist_CPFS
      * const whitelist_CPFS = await prisma.whitelist_CPF.findMany()
      * ```
      */
    get whitelist_CPF(): Prisma.Whitelist_CPFDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     ...
     * `prisma.mediaLibrary`: Exposes CRUD operations for the **MediaLibrary** model.
      ...
      * ```
      */
    get mediaLibrary(): Prisma.MediaLibraryDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
